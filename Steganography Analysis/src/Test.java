...
public class Test {
  ...
  // embed secret information/TEXT into a "cover image"
	...
	public static void main(String[] args) {
		...
		try {
			originalImageText = ImageIO.read(new File("C:\\Users\\Vishnutej\\Desktop\\fedal.jpg"));
			coverImageText = ImageIO.read(new File("C:\\Users\\Vishnutej\\Desktop\\fedal.jpg"));
			originalImage = ImageIO.read(new File("C:\\Users\\Vishnutej\\Desktop\\fedal.jpg"));
			coverImage = ImageIO.read(new File("C:\\Users\\Vishnutej\\Desktop\\fedal.jpg"));
			secretImage = ImageIO.read(new File("C:\\Users\\Vishnutej\\Desktop\\fedal.jpg"));
			...
			extractText(ImageIO.read(new File("textEmbedded.png")), s.length());
			System.out.print("Embedding1: ");
